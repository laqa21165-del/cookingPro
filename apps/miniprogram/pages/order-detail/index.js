...
Page({
    ...
    async loadData() {
        try {
            const [rawOrder, me] = await Promise.all([(0, order_1.getOrderDetail)(this.orderId), (0, auth_1.refreshMe)()]);
    ...
    async handleComplete() {
        try {
            await (0, order_1.completeOrder)(this.orderId, this.data.chefReply);
